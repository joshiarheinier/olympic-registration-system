<div class="page-container">
	<div id="entry-name">
		<h1><u>Entry Name: <?= $sport_name ?></u></h1>
		...
		<form action="<?= base_url();?>admin/official/pdf/download/entry/name" method="post">
			<input type="hidden" name="faculty" value="<?= $this->input->post("faculty"); ?>">
			<input type="hidden" name="sport_name" value="<?= $this->input->post("sport_name"); ?>">
