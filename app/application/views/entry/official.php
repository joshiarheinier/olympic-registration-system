<div class="page-container">
	<div id="entry-name">
		<h1><u>Isi Entry Name Official: <?= $category ?></u></h1>
		<div class="card entry-form" id="entry-name-form">
			<h4>Jumlah maksimal: <?= $max_official ?> official</h4>
			<hr>
			<div id="participant-container">
				<div id="participant-detail">
					<?php
					foreach ($participant as $row) {
						$html = '<div class="row"><div class="col-lg-9 col-md-9"><div class="row"><div class="col-lg-4 col-md-4"><h4>NPM</h4></div><div class="col-lg-8 col-md-8"><h5>'.$row->npm.'</h5></div></div><div class="row"><div class="col-lg-4 col-md-4"><h4>Nama Lengkap</h4></div><div class="col-lg-8 col-md-8"><h5>'.$row->full_name.'</h5></div></div><div class="row"><div class="col-lg-4 col-md-4"><h4>Jurusan</h4></div><div class="col-lg-8 col-md-8"><h5>'.$row->major.'</h5></div></div><div class="row"><div class="col-lg-4 col-md-4"><form action="'.base_url().'entry/official/delete/process" method="post"><input type="hidden" name="category" value="'.$category.'"><input type="hidden" name="participant_id" value="'.$row->npm.'"><input class="btn btn-danger" type="submit" value="Hapus"></form></div><div class="col-lg-4 col-md-4"><button class="btn btn-info" data-toggle="modal" data-target="#'.$row->npm.'-idcard-modal">Lihat KTM</button></div><div class="col-lg-4 col-md-4"><button class="btn btn-info" data-toggle="modal" data-target="#'.$row->npm.'-ss-modal">Lihat Screenshot</button></div></div></div><div class="col-lg-3 col-md-3"><img src="'.$row->image_link.'" height="175" width="135"></div></div><hr>';
				...
				<form enctype="multipart/form-data" id="participant-data" method="post">
					...
					<input type="hidden" name="link" value="<?= base_url(); ?>api/entry/official/process">
